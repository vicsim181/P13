...
class ProjectUnitaryTests(APITestCase):
    ...
    def test_consult_questions_linked_to_project(self):
        ...
        data = json.loads(response_2.render().content)
        print("self.assertEqual(data['question'], ['http://testserver/api/question/question_test.id_question/'])")
        self.assertEqual(data['question'], [f'http://testserver/api/question/{question_test.id_question}/'])
        print("ASSERT 3 DONE")
...
class ProjectQuestionIntegrationTests(APITestCase):
    ...
    def test_create_project_question_consult_delete_question(self):
        ...
        print("self.assertEqual(data['question'], ['http://testserver/api/question/question_test.id_question/'])")
        self.assertEqual(data['question'], [f'http://testserver/api/question/{test_question_to_retrieve.id_question}/'])
        print("ASSERT 5 DONE")
